"""CLI.
  ...
  python -m code_engine build "idea" [--out DIR]
  python -m code_engine impact <project_dir> <component>
  python -m code_engine evolve <project_dir>
  python -m code_engine patterns
"""
...
async def _main() -> int:
    parser = argparse.ArgumentParser(prog="code_engine")
