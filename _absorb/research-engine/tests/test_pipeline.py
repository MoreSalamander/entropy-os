...
from research_engine.extraction.extractor import EvidenceExtractor
from research_engine.graphs.context_graph import ContextGraph
from research_engine.llm.client import FakeLLM
from research_engine.models import RawDoc, SourceCategory, SourceStatus
from research_engine.orchestrator.orchestrator import ResearchOrchestrator
from research_engine.orchestrator.queue import AsyncioQueueBackend
from research_engine.planner.planner import AGENT_ARCHETYPES, ResearchPlanner
from research_engine.sources.base import SourceAdapter
from research_engine.storage.ledger import Ledger
...
class TestOrchestrator:
    ...
    async def test_true_parallel_fanout(self, plan, tmp_path):
        ...
        from research_engine.models import AgentSpec
