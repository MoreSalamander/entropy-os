...
(`research_engine.llm.client.LLMClient`): `chat_json`, `chat_text`, `embed`,
...
# The engines all import their LLM types from research_engine, so there is
...
try:                                          # pragma: no cover - env dependent
    from research_engine.llm.client import LLMUnavailable
