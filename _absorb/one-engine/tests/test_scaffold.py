...
from one_engine.contract import ExecuteRequest, ExecuteResult, SemanticEvent
from one_engine.scaffold import (
    CurriculumIsOrdered,
    Determinism,
    EvidenceFloor,
    ProducedSomething,
...
from one_engine.scaffold.verdict import GateVerdict, StageJudgment
...
def test_the_workflow_import_graph_stays_free_of_io():
    ...
    probe = (
        ...
        "importlib.import_module('one_engine.orchestration.stages');"
        "importlib.import_module('one_engine.scaffold');"
