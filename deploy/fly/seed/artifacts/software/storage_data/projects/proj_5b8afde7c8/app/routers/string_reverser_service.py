...
def list_string_reversal_request_390(session: Annotated[Session, Depends(get_session)]):
...
def create_string_reversal_request_483(payload: schemas.StringReversalRequestCreate, session: Annotated[Session, Depends(get_session)]):
...
def get_string_reversal_request_384(item_id: int, session: Annotated[Session, Depends(get_session)]):
...
def delete_string_reversal_request_235(item_id: int, session: Annotated[Session, Depends(get_session)]):
...
def list_string_reversal_response_405(session: Annotated[Session, Depends(get_session)]):
...
def create_string_reversal_response_1(payload: schemas.StringReversalResponseCreate, session: Annotated[Session, Depends(get_session)]):
...
def get_string_reversal_response_191(item_id: int, session: Annotated[Session, Depends(get_session)]):
...
def delete_string_reversal_response_335(item_id: int, session: Annotated[Session, Depends(get_session)]):
