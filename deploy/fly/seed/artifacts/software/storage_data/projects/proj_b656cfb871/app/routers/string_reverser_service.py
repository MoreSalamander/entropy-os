...
def list_string_reversal_request_541(session: Annotated[Session, Depends(get_session)]):
...
def create_string_reversal_request_129(payload: schemas.StringReversalRequestCreate, session: Annotated[Session, Depends(get_session)]):
...
def get_string_reversal_request_212(item_id: int, session: Annotated[Session, Depends(get_session)]):
...
def delete_string_reversal_request_966(item_id: int, session: Annotated[Session, Depends(get_session)]):
...
def list_string_reversal_response_571(session: Annotated[Session, Depends(get_session)]):
...
def create_string_reversal_response_905(payload: schemas.StringReversalResponseCreate, session: Annotated[Session, Depends(get_session)]):
...
def get_string_reversal_response_684(item_id: int, session: Annotated[Session, Depends(get_session)]):
...
def delete_string_reversal_response_999(item_id: int, session: Annotated[Session, Depends(get_session)]):
