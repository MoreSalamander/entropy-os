...
Real values never touch entropy_os/keytracker.py's SQLite file, never go through a
...
from entropy_os.keytracker import KeyRecord, KeyTrackerStore  # noqa: E402

SERVICE = "entropy-keytracker"
REPO_ROOT = Path.home() / "MoreSalamander"
# The ledger stays at the historical engine-side location (the split moved no
# data files); ENTROPY_DATA relocates it if that ever changes.
from entropy_os.config import default_data_dir  # noqa: E402

DB_PATH = default_data_dir() / "keytracker.sqlite3"
