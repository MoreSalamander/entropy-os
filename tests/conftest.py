...
from design_engine.models import (DesignSystem, FontClass, MotionLevel,
                                  PageKind, PagePlan, Palette, ProjectIntent,
                                  SectionKind)
from design_engine.research.site_analyzer import SiteAnalyzer
...
async def write_demo_site(tmp_path, intent, design_system):
    ...
    from design_engine.codegen.project_writer import _PAGE_HREFS, ProjectWriter
