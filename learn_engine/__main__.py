"""CLI.
  ...
  python -m learn_engine study "Teach me machine learning" --steps 3
  ...
  python -m learn_engine report <learner_json>   mastery report
"""
...
async def _main() -> int:
    parser = argparse.ArgumentParser(prog="learn_engine")
